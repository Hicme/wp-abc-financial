...
trait Calendar
{
  ...
  public function attendance_event( $event_id, $member_id )
  {
  ...
  public function subscribe_event( $event_id, $member_id )
  {
    $client_id = get_option( 'abcf_client_id', false );
    $client_secret = get_option( 'abcf_client_secret', false );
    $app_id = get_option( 'abcf_id', false );
    ...
    $url = "https://api.abcfinancial.com/rest/{$club_number}/calendars/secured/events/{$event_id}/members/{$member_id}";
